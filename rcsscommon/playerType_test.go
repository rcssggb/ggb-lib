...
func TestPlayerType13(t *testing.T) {
	errCh := make(chan string, 32)
	playerTypeData := ParsePlayerType(
...
func TestPlayerType00(t *testing.T) {
	errCh := make(chan string, 32)
	playerTypeData := ParsePlayerType(
		"(player_type (id 0)(player_speed_max 1.05)(stamina_inc_max 45)(player_decay 0.4)(inertia_moment 5)(dash_power_rate 0.006)(player_size 0.3)(kickable_margin 0.7)(kick_rand 0.1)(extra_stamina 50)(effort_max 1)(effort_min 0.6)(kick_power_rate 0.027)(foul_detect_probability 0.5)(catchable_area_l_stretch 1))\x00",
		errCh,
	)
	close(errCh)
